...
export function Skills() {
  const educations = [
    {
      name: "Estudante de Ciência da Computação | CESUPA",
    },
    {
      name: "Curso de Java Completo 2023  | Udemy",
    },
    ...
    return (
        <section className="rounded-br-[80px] bg-gray-300 md:rounded-br-[180px]">
                <div className="container mx-auto max-w-5xl p-4 py-12">
                    ...
                    Full-Stack Developer | Java Spring | Node.js | React Native |
                    </p>
                    <p className="relative text-sm text-gray-700 mb-4">
                     React.js | TypeScript | TailwindCSS | JavaScript
                    </p>
